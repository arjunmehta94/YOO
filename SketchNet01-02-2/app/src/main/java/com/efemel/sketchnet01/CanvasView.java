...
public class CanvasView extends View {
    ...
    //private float mockDtranslateX = 0f;
    //private float mockDtranslateY = 0f;

    //private float DpreviousTranslateX = 0f;
    //private float DpreviousTranslateY = 0f;

    private static float MIN_ZOOM = 1f;
    private static float MAX_ZOOM = 20000f;

    private static float scaleFactor = 1.f;
    private static float mockScaleFactor = 1.f;
    ...
    public void redrawStrokes() {//implement vector graphics here
        ...
        for(int i=0; i<strokes.size(); i++) {
            ...
            drawPath.moveTo((strokes.get(i).coordinates.get(0).X*scaleFactor + DtranslateX), (strokes.get(i).coordinates.get(0).Y*scaleFactor + DtranslateY));
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch(event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                //thisStroke.addCoordinate((touchX - DpreviousTranslateX)/scaleFactor,(touchY - DpreviousTranslateY)/scaleFactor);
                thisStroke.addCoordinate((touchX - DtranslateX)/scaleFactor, (touchY - DtranslateY)/scaleFactor);
                break;
            case MotionEvent.ACTION_POINTER_DOWN:
                mode = ZOOMnDRAG;
                scaleDetector.onTouchEvent(event);
                DstartX = event.getX()-DtranslateX;
                DstartY = event.getY()-DtranslateY;
            ...
            case MotionEvent.ACTION_MOVE:
                if(mode == DRAW) {
                    ...
                    //mockDtranslateX = DtranslateX;
                    //mockDtranslateY = DtranslateY;
